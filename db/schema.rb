...
ActiveRecord::Schema[7.0].define(version: 2023_09_08_015835) do
  ...
  create_table "paymentdetails", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.string "menu_type"
    t.integer "menu_id"
